...
public class SendEmail {
	...
	public static void sendMessage(String smtpHost, String from,
		...
		transport.connect(smtpHost, "", fromUserPassword);
...
//		try {
//			SendEmail.sendMessage("smtp.gmail.com", "karemjohn@gmail.com",
...
//		}
		try {
			SendEmail.sendMessage("smtp.163.com", "lucifer_lsl@163.com",
					AppConfig.getStringPro("pkWeyd"), "1039466810@qq.com", "nihao",
					"---------------wrwe-----------",
					"text/html;charset=gb2312");
		} catch (MessagingException e) {
			// TODO Auto-generated catch block
